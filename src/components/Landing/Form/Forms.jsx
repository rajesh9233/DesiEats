    ...
    <>
      <Modal show={showForms} onHide={handleCloseFormsPopUp} animation={true}>
        ...
        <Modal.Body>
            ...
            <div className="form-containers">
              <div className="btn-container">
                <Button
                  className={
                    activeButton === "1"
                      ? "login_button Activebutton mb-4"
                      : "login_button   mb-4"
                  }
                  onClick={() => {
                    toggleForm("login");
              ...
              <div className="btn-container">
                <Button
                  className={
                    activeButton === "2"
                      ? "login_button1 Activebutton mb-4"
                      : "login_button1   mb-4"
                  }
                  onClick={() => {
                    toggleForm("signup");
          ...
          {isShowLogin ? (
            <Login
              loginResposeFunction={loginResposeFunction}
              handleCloseFormsPopUp={handleCloseFormsPopUp}
              loginResposeFunctionValues={loginResposeFunctionValues}

        ...
        {showorder === (tabValue === "1") ? (
          <Row>
            ...
            <Col lg="2" style={{ fontWeight: "700", fontSize: "140%" }}>
              <p
                className={
                  tabValue === "1" && myorder === "1" ? "order" : "nullOrder"
                }
            ...
            <Col lg="2" style={{ fontWeight: "700", fontSize: "140%" }}>
              <p
                className={
                  tabValue === "1" && myorder === "2" ? "order" : "nullOrder"
                }
        ...
        <Row>
          <Col lg="2">
            <Card
              ...
              style={{ width: "18rem", borderRadius: "none" }}
            >
              <Card.Body>
                <Row>
                  <Col lg="3" />
                ...
                <Row>
                  <Col lg="12">
                    <Card.Title
                      className="UserNameProfilePage mt-2 ms-2"
                ...
                <Row>
                  ...
                  <Col lg="8">
                    <p
                      className={
                        active === (tabValue === "2") ? "active" : null
                      }
                      onClick={() => handleClicked("2")}
                    >
                      <GiWallet style={{ height: "1%", width: "15%" }} /> Wallet
                    </p>
                  </Col>
                </Row>
                <HorizantalBorder />
                <Row>
                  ...
                  <Col lg="8">
                    <p
                      className={
                        active === (tabValue === "3") ? "active" : null
                      }
                      onClick={() => handleClicked("3")}
                    >
                      <GrMap style={{ height: "1%", width: "15%" }} /> Address
                    </p>
                  </Col>
                </Row>
                <HorizantalBorder />
                      ...
                      <Col lg="9">
                        ...
                        <Collapse in={open} dimension="width">
                          <div id="example-collapse-text">
                            <p
                              className={
                                active === (tabValue === "6") ? "active" : null
                              }
                              onClick={() => handleClicked("6")}
                            >
                              <AiFillMessage
                                style={{ height: "1%", width: "15%" }}
                              />
                              Chat with us
                            </p>
                            <p
                              className={
                                active === (tabValue === "7") ? "active" : null
                              }
                              onClick={() => handleClicked("7")}
                            >
                              <MdCall style={{ height: "1%", width: "15%" }} />
                              Talk with us
                            </p>
                          </div>
                        </Collapse>
